...
public class ThirdPass {
    ...
    static void tokenizeThirdPass(String inputFile, String outputFile) throws FileNotFoundException{
        ...
        while (scan.hasNext()==true){ //while there is still content in the file
           ...
           // System.out.println(lineOfCode.substring(lineOfCode.length()-2,lineOfCode.length()));
            
            if ((lineOfCode.substring(lineOfCode.length()-2,lineOfCode.length())).equals("::")){
                lineOfCode = lineOfCode.substring(0, lineOfCode.length()-1);
            }
