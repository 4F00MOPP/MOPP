                ...
                <div class="card cardBackgroundTile text-center m-3 mx-auto p-3">
                    ...
                    ?>
                        ...
                        <div class="welcome">
                            ...
                            <?php endif ?>
                            <form class="form-submit mx-auto" action="./bulkSubmit.php">
                                <button class="btn btn-block btn-secondary mt-2 mx-auto" type="submit">TEST</button>
                            </form>
                            ...
                            <form class="form-logOut mx-auto" action="./index.php">
                                <a href="testing_home.php?logout='1'">
