                ...
                <div class="card cardBackgroundTile text-center m-3 mx-auto p-3">
                    ...
                    ?>
                        ...
                        <div class="welcome">
                            ...
                            <?php endif ?>
                            <form class="form-submit mx-auto" action="./student_submit.php">
                                <button class="btn btn-block btn-secondary mt-2 mx-auto" type="submit">Submit Assignment</button>
                            </form>
                            <form class="form-logOut mx-auto" action="./index.php">
                                <a href="student_home.php?logout='1'">
